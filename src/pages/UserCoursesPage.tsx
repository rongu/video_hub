    ...
    return (
        <div className="min-h-screen w-full bg-gray-100 flex flex-col">
            ...
            <header className="bg-white shadow-md p-4 flex justify-between items-center w-full">
                <h1 className="text-2xl font-bold text-[#1A73E8]">Video Hub - Khóa học</h1>
            ...
            <main className="flex-grow p-8">
                <div className="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-600">
                        Bạn đã truy cập thành công với vai trò **USER**. Đây là nơi các khóa học sẽ được hiển thềE
                    </p>
                    <p className="mt-2 text-sm text-[#1A73E8]">
                        ID người dùng (UID): {user.uid}
                    </p>
                    <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <p className="font-semibold text-yellow-800">Cần làm:</p>
                        <p className="text-yellow-700 text-sm">ềELevel 2, chúng ta sẽ xây dựng giao diện hiển thềEdanh sách các Khóa học công khai tại đây.</p>
                    </div>
                </div>
            </main>
            <footer className="py-12 border-t border-gray-100 text-center text-gray-400 text-[10px] font-black uppercase tracking-widest">
                <p>© 2025 VideoHub. Học tập đềEvươn xa.</p>
            </footer>
        </div>
    );
};
